...
void ShowAddbookView(HWND hwnd) {
    ...
    SendMessage(AddbookQsaleInput, EM_SETLIMITTEXT, (WPARAM)2, 0);
    ...
    SendMessage(AddbookQrentInput, EM_SETLIMITTEXT, (WPARAM)2, 0);
    ...
    SendMessage(AddbookRdurationInput, EM_SETLIMITTEXT, (WPARAM)2, 0);
